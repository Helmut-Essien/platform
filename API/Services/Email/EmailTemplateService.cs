...
public class EmailTemplateService
{
    ...
    public (string Subject, string Html) PasswordReset(string email, string resetLinkPlaceholder = "{{RESET_LINK}}") =>
        ("Reset your Platform admin password",
            Wrap(email,
                ...
                <p style="margin:0 0 16px;"><a href="{resetLinkPlaceholder}" style="display:inline-block;padding:12px 20px;background:#5c9f24;color:#ffffff;text-decoration:none;border-radius:6px;font-weight:600;">Reset password</a></p>
                <p style="margin:0 0 16px;font-size:14px;color:#55604e;">If the button does not work, copy this URL into your browser:<br /><span style="word-break:break-all;">{resetLinkPlaceholder}</span></p>
